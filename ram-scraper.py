...
# MAIN
ram_csv = open(r"C:\\Users\\Will Borucki\\Desktop\\pc_code\\vs_code\scrapers\\ram-price.csv", "a", newline='')
...
if __name__ == '__main__':
    while True: 
        ...
        print(f'ram prices will update in {minutes} minute(s)')
        time.sleep( 60 * minutes ) # sleeps for 24 hours
